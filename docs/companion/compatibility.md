...
| --- | --- |
| Companion extension | 1.13.0; stable ID `dioapemglpdpmfmoekckbpenmpdgkofp` <!-- x-release-please-version --> |
| Native host | 1.13.0 on macos arm64 and x86_64 <!-- x-release-please-version --> |
| Native protocol | 1 |
