...
export enum MessageType {
  ...
  GET_RECENT_NETWORK_MEDIA = "GET_RECENT_NETWORK_MEDIA",
  ...
  OFFSCREEN_CREATE_MEDIA_BLOB = "OFFSCREEN_CREATE_MEDIA_BLOB",
  OFFSCREEN_CREATE_MEDIA_BLOB_RESPONSE = "OFFSCREEN_CREATE_MEDIA_BLOB_RESPONSE",
